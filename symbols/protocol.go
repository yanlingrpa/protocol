...
func init() {
	Symbols["yanlingrpa.com/yanling/protocol/basic"] = map[string]reflect.Value{
		...
		"Rect.CenterPoint": reflect.ValueOf(basic.Rect.CenterPoint),
		"Rect.Compare": reflect.ValueOf(basic.Rect.Compare),
		"Rect.Contains": reflect.ValueOf(basic.Rect.Contains),
		"Rect.ContainsPoint": reflect.ValueOf(basic.Rect.ContainsPoint),
	...
	Symbols["yanlingrpa.com/yanling/protocol/osgui"] = map[string]reflect.Value{
		...
		"CapA": reflect.ValueOf(osgui.CapA), // Export CapA constant
		"CapB": reflect.ValueOf(osgui.CapB), // Export CapB constant
		"CapC": reflect.ValueOf(osgui.CapC), // Export CapC constant
		"CapD": reflect.ValueOf(osgui.CapD), // Export CapD constant
		"CapE": reflect.ValueOf(osgui.CapE), // Export CapE constant
		"CapF": reflect.ValueOf(osgui.CapF), // Export CapF constant
		"CapG": reflect.ValueOf(osgui.CapG), // Export CapG constant
		"CapH": reflect.ValueOf(osgui.CapH), // Export CapH constant
		"CapI": reflect.ValueOf(osgui.CapI), // Export CapI constant
		"CapJ": reflect.ValueOf(osgui.CapJ), // Export CapJ constant
		"CapK": reflect.ValueOf(osgui.CapK), // Export CapK constant
		"CapL": reflect.ValueOf(osgui.CapL), // Export CapL constant
		"CapM": reflect.ValueOf(osgui.CapM), // Export CapM constant
		"CapN": reflect.ValueOf(osgui.CapN), // Export CapN constant
		"CapO": reflect.ValueOf(osgui.CapO), // Export CapO constant
		"CapP": reflect.ValueOf(osgui.CapP), // Export CapP constant
		"CapQ": reflect.ValueOf(osgui.CapQ), // Export CapQ constant
		"CapR": reflect.ValueOf(osgui.CapR), // Export CapR constant
		"CapS": reflect.ValueOf(osgui.CapS), // Export CapS constant
		"CapT": reflect.ValueOf(osgui.CapT), // Export CapT constant
		"CapU": reflect.ValueOf(osgui.CapU), // Export CapU constant
		"CapV": reflect.ValueOf(osgui.CapV), // Export CapV constant
		"CapW": reflect.ValueOf(osgui.CapW), // Export CapW constant
		"CapX": reflect.ValueOf(osgui.CapX), // Export CapX constant
		"CapY": reflect.ValueOf(osgui.CapY), // Export CapY constant
		"CapZ": reflect.ValueOf(osgui.CapZ), // Export CapZ constant
		...
		"Locator.CardLocator": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("CardLocator"),
		...
		"Locator.DragTo": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("DragTo"),
		...
		"Locator.MouseDown": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("MouseDown"),
		"Locator.MouseMove": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("MouseMove"),
		"Locator.MouseUp": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("MouseUp"),
		"Locator.OcrRead": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("OcrRead"),
		"Locator.PressKeys": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("PressKeys"),
		...
		"Locator.VisionLocator": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("VisionLocator"),
		"Locator.WaitForCard": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("WaitForCard"),
		"Locator.WaitForEditing": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("WaitForEditing"),
		"Locator.WaitForImage": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("WaitForImage"),
		"Locator.WaitForText": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("WaitForText"),
		"Locator.WaitForVision": reflect.ValueOf((*osgui.Locator)(nil)).MethodByName("WaitForVision"),
	...
	Symbols["yanlingrpa.com/yanling/protocol/script"] = map[string]reflect.Value{
		...
		"YScript": reflect.ValueOf((*script.YScript)(nil)).Elem(), // Export YScript struct
	}
}
