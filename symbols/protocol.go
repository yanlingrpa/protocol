...
func init() {
	Symbols["github.com/yanlingrpa/protocol/basic"] = map[string]reflect.Value{
	...
	Symbols["github.com/yanlingrpa/protocol/browser"] = map[string]reflect.Value{
	...
	Symbols["github.com/yanlingrpa/protocol/ossys"] = map[string]reflect.Value{
	...
	Symbols["github.com/yanlingrpa/protocol/script"] = map[string]reflect.Value{
