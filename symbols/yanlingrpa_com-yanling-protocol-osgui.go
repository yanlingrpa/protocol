...
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) ImageLocators(image string, sim float32) ([]osgui.Locator, error) {
	return W.WImageLocators(image, sim)
}
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) IsEditing() bool {
	return W.WIsEditing()
}
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) IsHorizontalScroller() bool {
	return W.WIsHorizontalScroller()
}
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) IsVerticalScroller() bool {
...
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) Ocr(confidence float64) (*basic.OcrResult, error) {
...
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) ScrollHorizontal(left bool, lines int) error {
	return W.WScrollHorizontal(left, lines)
}
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) ScrollVertical(up bool, lines int) error {
	return W.WScrollVertical(up, lines)
}
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) ShapeLocator(shape osgui.GraphicShape, min_size basic.Size, max_size basic.Size) (osgui.Locator, error) {
	return W.WShapeLocator(shape, min_size, max_size)
}
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) ShapeLocators(shape osgui.GraphicShape, min_size basic.Size, max_size basic.Size) ([]osgui.Locator, error) {
...
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) TextLocators(texts ...string) ([]osgui.Locator, error) {
...
func (W _yanlingrpa_com_yanling_protocol_osgui_Locator) WaitForEditing(timeout time.Duration) bool {
