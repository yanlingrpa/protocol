...
func init() {
	Symbols["github.com/yanlingrpa/protocol/script/script"] = map[string]reflect.Value{
		...
		"_ModuleRuntime": reflect.ValueOf((*_github_com_yanlingrpa_protocol_script_ModuleRuntime)(nil)),
		"_Subscriber":    reflect.ValueOf((*_github_com_yanlingrpa_protocol_script_Subscriber)(nil)),
	}
}

// _github_com_yanlingrpa_protocol_script_ModuleRuntime is an interface wrapper for ModuleRuntime type
type _github_com_yanlingrpa_protocol_script_ModuleRuntime struct {
	IValue            interface{}
...
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) CurrentSpecifier() string {
	return W.WCurrentSpecifier()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) DeviceInfo() ossys.DeviceInfo {
	return W.WDeviceInfo()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) FileSystem() ossys.LocalFilesystem {
	return W.WFileSystem()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) GetCacheData(key string) (any, bool) {
	return W.WGetCacheData(key)
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) GetVariable(name string) (any, bool) {
	return W.WGetVariable(name)
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) GuiWindow(id string) (osgui.GuiWindow, bool) {
	return W.WGuiWindow(id)
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) HostSpecifier() string {
	return W.WHostSpecifier()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) HttpClient() ossys.HttpClient {
	return W.WHttpClient()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) InvokeApi(specifier string, api string, args ...any) (any, error) {
	return W.WInvokeApi(specifier, api, args...)
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) Logger() ossys.ScriptLogger {
	return W.WLogger()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) SetCacheData(key string, value any) {
	W.WSetCacheData(key, value)
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) Storage() ossys.LocalStorage {
	return W.WStorage()
}
func (W _github_com_yanlingrpa_protocol_script_ModuleRuntime) Subscribe(specifier string, topic string, handler script.EventHandler) (script.Subscriber, error) {
...
type _github_com_yanlingrpa_protocol_script_Subscriber struct {
	IValue        interface{}
...
func (W _github_com_yanlingrpa_protocol_script_Subscriber) GetSpecifier() string {
	return W.WGetSpecifier()
}
func (W _github_com_yanlingrpa_protocol_script_Subscriber) GetTopic() string {
	return W.WGetTopic()
}
func (W _github_com_yanlingrpa_protocol_script_Subscriber) IsActive() bool {
	return W.WIsActive()
}
