// Code generated by 'yaegi extract yanlingrpa.com/yanling/protocol/browser'. DO NOT EDIT.
...
func init() {
	Symbols["yanlingrpa.com/yanling/protocol/browser/browser"] = map[string]reflect.Value{
		// type definitions
...
// _yanlingrpa_com_yanling_protocol_browser_BrowserElement is an interface wrapper for BrowserElement type
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) ContainsElement(target browser.BrowserElement) (bool, error) {
	return W.WContainsElement(target)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Disabled() (bool, error) {
	return W.WDisabled()
}
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) GetAttribute(name string) (string, error) {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Hover() error {
	return W.WHover()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Html() (string, error) {
	return W.WHtml()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Input(text string) error {
	return W.WInput(text)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Interactable() (basic.FPoint, error) {
	return W.WInteractable()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) MatchByCss(selector string) (bool, error) {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) ScrollIntoView() error {
	return W.WScrollIntoView()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SelectAllText() error {
	return W.WSelectAllText()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SelectByCss(selectors []string, selected bool) error {
	return W.WSelectByCss(selectors, selected)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SelectByRegex(regexes []string, selected bool) error {
	return W.WSelectByRegex(regexes, selected)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SelectByText(texts []string, selected bool) error {
	return W.WSelectByText(texts, selected)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SelectText(regex string) error {
	return W.WSelectText(regex)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SetAttribute(name string, value string) error {
	return W.WSetAttribute(name, value)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SetFiles(filePaths []string) error {
	return W.WSetFiles(filePaths)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) SetProperty(name string, value any) error {
	return W.WSetProperty(name, value)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Tap() error {
	return W.WTap()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Text() (string, error) {
	return W.WText()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) Visible() (bool, error) {
	return W.WVisible()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) WaitEnabled() error {
	return W.WWaitEnabled()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) WaitInteractable() (basic.FPoint, error) {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) WaitStableRAF() error {
	return W.WWaitStableRAF()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserElement) WaitVisible() error {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserFramePage) GetDomain() string {
	return W.WGetDomain()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserFramePage) GetID() string {
	return W.WGetID()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserFramePage) GetTitle() string {
	return W.WGetTitle()
}
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) ClearCookies() error {
	return W.WClearCookies()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) ClearLocalStorage() error {
	return W.WClearLocalStorage()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) Destroy() error {
	return W.WDestroy()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) Evaluate(jsCode string, arg ...any) (any, error) {
	return W.WEvaluate(jsCode, arg...)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) GetDomain() string {
	return W.WGetDomain()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) GetID() string {
	return W.WGetID()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) GetTitle() string {
	return W.WGetTitle()
}
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) LoadCookies() error {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserTabPage) SaveCookies() error {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) CurrentPage() browser.BrowserTabPage {
	return W.WCurrentPage()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) DeActivate() (bool, error) {
	return W.WDeActivate()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) DefaultPage() browser.BrowserTabPage {
	return W.WDefaultPage()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetClientRect() basic.Rect {
	return W.WGetClientRect()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetHwnd() uintptr {
	return W.WGetHwnd()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetID() string {
	return W.WGetID()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetInitiatorPath() string {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetWindowCursorPos() *basic.Point {
	return W.WGetWindowCursorPos()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetWindowRect() basic.Rect {
	return W.WGetWindowRect()
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) GetWindowSchema() string {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) NewTabPage(id string, url string) (browser.BrowserTabPage, error) {
	return W.WNewTabPage(id, url)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) PressKeys(keys ...osgui.Keyboard) error {
...
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) TransFromScreen(screen_pos *basic.Point) *basic.Point {
	return W.WTransFromScreen(screen_pos)
}
func (W _yanlingrpa_com_yanling_protocol_browser_BrowserWindow) TransToScreen(window_pos *basic.Point) *basic.Point {
